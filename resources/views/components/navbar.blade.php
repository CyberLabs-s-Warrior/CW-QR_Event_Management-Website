 <div class="navbar-header">
     <div class="row align-items-center justify-content-between">
         ...
         <div class="col-auto">
             <div class="d-flex flex-wrap align-itemshttps://moderate-garmin-tin-crowd.trycloudflare.com-center gap-3">
         ...
         <div class="modal-content radius-16">
             ...
             <div class="modal-footer border-0">
                 ...
                 <form action="{{ route('logout') }}" method="POST" class="d-inline">
                     @csrf
                     <button type="submit" class="btn btn-sm btn-danger">Ya, Logout</button>
                 </form>
             </div>
         </div>
     </div>
